...
The initial YOLO model was used to annotate a larger dataset of 2600 images, with each card having 50 instances. The improved model uses a YOLOv26l model, and was trained for 200 epochs, with a patience of 40, 8 workers, and a batch size of 16.
